...
class trainingModels(models.Model):
    fileModel = models.FileField(null=True) #intentas guardar un archivo de texto
    ...
    insert_time = models.DateField(auto_now=True)  #guarda tiempo en que fueron insertados los modelos, para saber si ya son modelos muy viejos y saber si están desaxtualizados
